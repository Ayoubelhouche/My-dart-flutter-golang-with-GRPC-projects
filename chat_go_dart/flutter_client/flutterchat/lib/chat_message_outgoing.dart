...
class MessageOutgoing extends Message {
  ...
  /// Constructor
  MessageOutgoing(
      {required String text, required String id, this.status = MessageOutgoingStatus.UNKNOWN})
      : super(text, id);
}
...
class ChatMessageOutgoing extends StatefulWidget implements ChatMessage {
  ...
  /// Constructor
  ChatMessageOutgoing({required this.message, required this.animationController})
...
class ChatMessageOutgoingState extends State<ChatMessageOutgoing> {
  ...
  /// Constructor
  ChatMessageOutgoingState({required this.controller, required this.animationController}) {
