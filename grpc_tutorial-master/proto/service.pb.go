...
var fileDescriptor_a0b84a42fa06f626 = []byte{
	...
	0x5c, 0x9a, 0x53, 0x02, 0x55, 0x0c, 0xe5, 0x19, 0xf5, 0x30, 0x72, 0x71, 0x39, 0xa6, 0xa4, 0x04,
	...
	0x53, 0x49, 0x58, 0xb1, 0x26, 0x17, 0x9b, 0x4b, 0x6a, 0x59, 0x66, 0x4a, 0x2a, 0x41, 0xa5, 0x49,
	0x6c, 0x60, 0xbe, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0xe3, 0x62, 0x1d, 0xff, 0xf8, 0x00, 0x00,
	0x00,
}
...
func (c *addServiceClient) Devide(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/proto.AddService/Devide", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedAddServiceServer) Devide(ctx context.Context, req *Request) (*Response, error) {
...
func _AddService_Devide_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AddServiceServer).Devide(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.AddService/Devide",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AddServiceServer).Devide(ctx, req.(*Request))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _AddService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Devide",
			Handler:    _AddService_Devide_Handler,
		},
	},
